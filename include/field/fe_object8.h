...
extern s32  opHandler_OP16B(Eline *eline);
extern s32  opHandler_OP16C(Eline *eline);
extern s32  opHandler_OP16D(Eline *eline);
extern s32  opHandler_OP16E(Eline *eline);
