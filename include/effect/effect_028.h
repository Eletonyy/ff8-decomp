...
typedef struct {
    ...
    /* 0x11 */ u8 unk011;
    /* 0x12 */ u8 unk012;     /**< Frames a mote taken from this source lives. */
...
/**
 * @brief The tighter of the two record kinds the draw list carries.
 *
 * Its bank packs these 0x6C apart, so it shares only the head of
 * @ref EffectDrawNode and is linked through the same two pointers.
 */
typedef struct EffectMote {
    /* 0x00 */ struct EffectDrawNode *prev;
    /* 0x04 */ struct EffectDrawNode *next;
    /* 0x08 */ u16 unk008;
    /* 0x0A */ u8 pad00A[0x2C - 0xA];
    /* 0x2C */ MATRIX mtx;   /**< Turns the step's offset into world space. */
    /* 0x4C */ VECTOR pos;   /**< Where the mote sits, 16.16. */
    /* 0x5C */ struct EffectDrawNode *owner;
    ...
    /* 0x69 */ u8 taken;      /**< Non-zero while this slot is in use. */
    /* 0x6A */ u8 unk06A;     /**< Which of the list's sources drives it. */
    /* 0x6B */ u8 unk06B;
} EffectMote; /* 0x6C */

/** @brief One entry on the effect's draw list, linked both ways. */
typedef struct EffectDrawNode {
    /* 0x000 */ struct EffectDrawNode *prev;
    /* 0x004 */ struct EffectDrawNode *next;
    /* 0x008 */ s16 unk008;
    ...
    /* 0x08C */ MATRIX orient; /**< Turn the motes hung off this node inherit. */
...
typedef struct {
    ...
    /* 0x02C */ EffectDrawNode *head;
    /* 0x030 */ EffectDrawNode *tail;
...
extern EffectDrawList *D_801D3F84;
...
extern void *D_801D479C;

extern s32 D_801D49FC;

/** @brief The sixteen hex digit glyphs, cached from the main string table. */
extern u8 D_801D4ADC[];

/** @brief Debug text cursor: X, Y, and the colour the glyphs are drawn in. */
extern s32 D_801D4AF0;

extern s32 D_801D4AF4;

extern s32 D_801D4AF8;

/** @brief The two prim banks the emitters write through. */
extern EffectMote *D_801D3F7C;
extern EffectDrawNode *D_801D3F80;

/** @brief Frame counters the script resets when it restarts. */
extern s16 D_801D3F88;
extern s16 D_801D3F8A;
extern s16 D_801D3F90;
extern s16 D_801D3F92;
...
extern s32 D_801D478C;

/** @brief Cursor the prim banks are carved off, moving up as they are taken. */
...
extern u16 D_801D3F8C;
extern u16 D_801D3F8E;
